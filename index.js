...
var textures = ['1.jpg', '2.jpg', '3.jpg','4.jpg', '5.jpg', '6.jpg','7.jpg', '8.jpg', '9.jpg','10.jpg', '11.gif']
var x = -0.140, y=0.610, z=2.16499, aa=0, ss=1.3049, dd=0, toggle=false, t, allTextures, song;
const SPEED = 0.0015;
//seconds
const FIRST_ROTATION =32;
const NEXT_ROTATIONS =15;
const rotor = Array.from(Array(5).keys())
var currentRotor = 0
...
function main() {
  ...
  function updateNthTexture() {
    ...
    if (nextTextureIndex > allTextures.length -1) {
      rotor[currentRotor] = nextTextureIndex % 5;
    } else {
